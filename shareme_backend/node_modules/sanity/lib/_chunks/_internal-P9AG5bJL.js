...
import fs$2, { readdir } from 'node:fs/promises';
...
const validateDocumentsCommand$1 = {
  ...
  helpText: helpText$g,
  action: async (args, context) => {
    const mod = await import('./validateAction-ogcTtQ_s.js');
    return mod.default(args, context);
  }
};
...
const listGraphQLAPIsCommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./listApisAction-ioMtu4nP.js');
    return mod.default(args, context);
  },
  helpText: helpText$7
};
...
const deployGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deployApiAction-SyxgtH6B.js');
    return mod.default(args, context);
  },
  helpText: helpText$6
};
...
const createMigrationCommand$1 = {
  ...
  action: async (args, context) => {
    ...
    await fs$2.writeFile(path.join(workDir, definitionFile), renderedTemplate);
    output.print();
...
//# sourceMappingURL=_internal-P9AG5bJL.js.map
