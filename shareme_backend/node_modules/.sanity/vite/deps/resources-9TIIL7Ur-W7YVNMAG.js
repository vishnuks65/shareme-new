...
// node_modules/sanity/lib/_chunks/resources-9TIIL7Ur.js
var commentsLocaleStrings = defineLocalesResources("comments", {
  ...
  "comments.delete-thread-body": "This comment and its replies will be deleted, and once deleted cannot be recovered.",
  ...
  "comments.list-status-empty-state-open-text": "Open comments on this document will be shown here.",
  /**The empty state title for open comments */
  "comments.list-status-empty-state-open-title": "No open comments yet",
  /**The empty state text for resolved comments */
  "comments.list-status-empty-state-resolved-text": "Resolved comments on this document will be shown here.",
  ...
  "comments.onboarding-popover-body": "You can add comments to any field in a document. They`ll show up here, grouped by field.",
  ...
  "comments.user-reacted-with": "<Content/> <Text>reacted with </Text> <ReactionName>{{reactionName}}</ReactionName>"
});
export {
  commentsLocaleStrings as default
};
//# sourceMappingURL=resources-9TIIL7Ur-W7YVNMAG.js.map
