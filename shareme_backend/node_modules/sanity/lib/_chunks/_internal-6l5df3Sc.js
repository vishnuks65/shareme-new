...
const validateDocumentsCommand$1 = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./validateAction-9RBe_kgV.js');
    });
    return mod.default(args, context);
  }
};
...
const listGraphQLAPIsCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./listApisAction-wPlcUnds.js');
    });
    return mod.default(args, context);
  },
  helpText: helpText$7
...
const deployGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./deployApiAction-mX0SgErv.js');
    });
    return mod.default(args, context);
  },
  helpText: helpText$6
...
const createMigrationCommand$1 = {
  ...
  action: async (args, context) => {
    ...
    await fs__default$2.default.writeFile(path__default.default.join(workDir, definitionFile), renderedTemplate);
    output.print();
...
//# sourceMappingURL=_internal-6l5df3Sc.js.map
