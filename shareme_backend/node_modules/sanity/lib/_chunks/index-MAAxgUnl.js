...
import { usePaneLayout, ChildLink, BackLink, ReferenceChildLink, ParameterizedLink, PaneRouterContext, useStructureTool, LOADING_PANE, structureLocaleNamespace, SerializeError, Pane, PaneHeader, PaneContent, LoadingPane, PaneLayout, setActivePanes, StructureToolProvider } from './structure-iqIDIH7-.js';
...
const paneMap = {
  component: lazy(() => import('./index-2kSxso3r.js')),
  document: lazy(() => import('./pane-cQxQtBcL.js')),
  documentList: lazy(() => import('./pane-QyVrOLqS.js')),
  list: lazy(() => import('./index-HcF369ru.js'))
};
...
//# sourceMappingURL=index-MAAxgUnl.js.map
