...
// node_modules/sanity/lib/_chunks/structure-iqIDIH7-.js
...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({ locale: "en-US", namespace: structureLocaleNamespace, resources: () => import("./resources-u_a8Mu5V-AF6LQXBP.js") });
...
var ReferenceChildLink = (0, import_react3.forwardRef)(function ReferenceChildLink2(_ref6, ref) {
  let { documentId, documentType, parentRefPath, children, template, ...rest } = _ref6;
...
var _d$4;
var _e$3;
var ChevronWrapper = ut(Box)(_a$F || (_a$F = __template$F(["\n  margin-left: auto;\n"])));
var CrossDatasetReferencesDetails = ut.details(_b$i || (_b$i = __template$F(["\n  flex: none;\n\n  &[open] ", " {\n    transform: rotate(180deg);\n  }\n"])), ChevronWrapper);
var CrossDatasetReferencesSummary = ut.summary(_c$8 || (_c$8 = __template$F(["\n  list-style: none;\n\n  &::-webkit-details-marker {\n    display: none;\n  }\n"])));
var Table = ut.table(_d$4 || (_d$4 = __template$F(["\n  width: 100%;\n  text-align: left;\n  padding: 0 ", ";\n  border-collapse: collapse;\n\n  th {\n    padding: ", ";\n  }\n\n  td {\n    padding: 0 ", ";\n  }\n\n  tr > *:last-child {\n    text-align: right;\n  }\n"])), (_ref7) => {
  let { theme } = _ref7;
...
var DocumentIdFlex = ut(Flex)(_e$3 || (_e$3 = __template$F(["\n  min-height: 33px;\n"])));
...
var _a$E;
var _b$h;
var DialogBody = ut(Box)(_a$E || (_a$E = __template$E(["\n  box-sizing: border-box;\n"])));
var LoadingContainer = ut(Flex).attrs({ align: "center", direction: "column", justify: "center" })(_b$h || (_b$h = __template$E(["\n  height: 110px;\n"])));
...
var _a$D;
var Root$e = ut(Layer)(_a$D || (_a$D = __template$D(["\n  position: relative;\n  width: 1px;\n  min-width: 1px;\n\n  &:before {\n    content: '';\n    display: block;\n    position: absolute;\n    top: 0;\n    left: 0;\n    bottom: 0;\n    width: 1px;\n    background-color: var(--card-border-color);\n  }\n\n  &:not([data-disabled]) {\n    cursor: ew-resize;\n    width: 9px;\n    min-width: 9px;\n    margin: 0 -4px;\n\n    &:before {\n      left: 4px;\n    }\n\n    &:after {\n      content: '';\n      display: block;\n      position: absolute;\n      top: 0;\n      left: 0;\n      width: 9px;\n      bottom: 0;\n      background-color: var(--card-border-color);\n      opacity: 0;\n      transition: opacity 150ms;\n    }\n\n    &[data-dragging]:after,\n    &:hover:after {\n      opacity: 0.2;\n    }\n  }\n"])));
...
var _a$C;
var Root$d = ut(Card)(_a$C || (_a$C = __template$C(["\n  outline: none;\n\n  // NOTE: This will render a border to the right side of each pane\n  // without taking up physical space.\n  box-shadow: 1px 0 0 var(--card-border-color);\n"])));
...
var _a$B;
var Root$c = ut(Card)(_a$B || (_a$B = __template$B(["\n  position: relative;\n  outline: none;\n"])));
...
var _a$A;
var _b$g;
var Root$b = ut(Layer)(_a$A || (_a$A = __template$A(["\n  position: sticky;\n  bottom: 0;\n\n  &:before {\n    content: '';\n    display: block;\n    position: absolute;\n    left: 0;\n    right: 0;\n    top: -1px;\n    border-bottom: 1px solid var(--card-border-color);\n  }\n"])));
var RootCard$1 = ut(Card)(_b$g || (_b$g = __template$A(["\n  padding-bottom: env(safe-area-inset-bottom);\n"])));
...
var _a$y;
var Root$9 = ut(Card)(_a$y || (_a$y = __template$y(["\n  transition: opacity 200ms;\n  position: relative;\n  z-index: 1;\n  padding-left: env(safe-area-inset-left);\n  padding-right: env(safe-area-inset-right);\n  opacity: 0;\n\n  &:not([hidden]) {\n    display: flex;\n  }\n\n  &:not([data-collapsed]) {\n    overflow: auto;\n  }\n\n  &[data-mounted] {\n    opacity: 1;\n  }\n\n  &[data-resizing] {\n    pointer-events: none;\n  }\n"])));
...
var PaneHeaderActions = (0, import_react3.memo)(function PaneHeaderActions2(props) {
  ...
  const initialValueTemplateItemFromMenuItems = (0, import_react3.useMemo)(() => {
    return menuItems.map((item, menuItemIndex) => {
      ...
      let { initialDocumentId, item, template, menuItemIndex, templateParams } = _ref21;
...
var commentsUsEnglishLocaleBundle = defineLocaleResourceBundle({ locale: "en-US", namespace: commentsLocaleNamespace, resources: () => import("./resources-9TIIL7Ur-W7YVNMAG.js") });
...
var _a$x;
var StyledAvatar = ut(Avatar)(_a$x || (_a$x = __template$x(["\n  svg > ellipse {\n    stroke: transparent;\n  }\n"])));
...
var _a$v;
var NormalText = ut(Text)(_a$v || (_a$v = __template$v(["\n  word-break: break-word;\n"])));
...
var _a$t;
var InnerFlex = ut(Flex)(_a$t || (_a$t = __template$t([""])));
...
function CommentReactionsMenu(props) {
  ...
  return (0, import_jsx_runtime2.jsx)(Grid, { columns: GRID_COLUMNS, gap: 1, onKeyDown: handleRootKeyDown, ref: setRootElement, role: "menu", children: options.map((o) => {
    ...
    return (0, import_jsx_runtime2.jsx)(Button, { "aria-label": t("comments.reactions-menu-button-aria-label", { reaction: o.title || o.shortName }), mode: "bleed", onClick: handleOptionClick, padding: 2, role: "menuitem", tabIndex: -1, children: (0, import_jsx_runtime2.jsx)(EmojiText, { align: "center", size: 2, children: emoji }) }, o.shortName);
  }) });
}
var POPOVER_FALLBACK_PLACEMENTS$1 = ["top", "bottom"];
function CommentReactionsMenuButton(props) {
  const { onMenuClose, onMenuOpen, onSelect, options, readOnly, renderMenuButton: renderMenuButton2 } = props;
  ...
  const button = (0, import_react3.useMemo)(() => {
    const btn = renderMenuButton2({ open, t });
    return (0, import_react3.cloneElement)(btn, { "aria-expanded": open, "aria-haspopup": "true", disabled: readOnly, id: "reactions-menu-button", onClick: handleClick, ref: setButtonElement, t });
  }, [handleClick, open, readOnly, renderMenuButton2, t]);
...
var _c$6;
var TEXT_SIZE = 1;
var ContentStack$1 = ut(Stack)(_a$p || (_a$p = __template$p(["\n  max-width: 180px;\n"])));
var InlineText = ut(Text).attrs({ size: TEXT_SIZE })(_b$c || (_b$c = __template$p(["\n  display: inline-block !important;\n"])));
var TextBox = ut(Box)(_c$6 || (_c$6 = __template$p(["\n  line-height: 1;\n  text-align: center;\n"])));
function UserDisplayName(props) {
  var _a2;
  const { currentUserId, isFirst, userId, separator: separator2 } = props;
  const [user] = useUser(userId);
  const { t } = useTranslation2(commentsLocaleNamespace);
  const isCurrentUser = currentUserId === userId;
  const you = isFirst ? t("comments.reaction-user-you") : t("comments.reaction-user-you-lowercase");
  const content = isCurrentUser ? you : (_a2 = user == null ? void 0 : user.displayName) != null ? _a2 : t("comments.reaction-unknown-user");
  const text = separator2 ? "".concat(content, ", ") : content;
  return (0, import_jsx_runtime2.jsxs)(InlineText, { weight: "medium", children: [" ", text, " "] });
}
...
function CommentReactionsUsersTooltipContent(props) {
  ...
  const content = (0, import_react3.useMemo)(() => {
    ...
    return userIds.map((id, index) => {
      const separator2 = index < userIds.length - 1 && len > 2 && index !== userIds.length - 2;
      const showAnd = index === len - 1 && len > 1;
      return (0, import_jsx_runtime2.jsxs)(import_react3.Fragment, { children: [showAnd && (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [(0, import_jsx_runtime2.jsxs)(InlineText, { children: [t("comments.reaction-separator"), " "] }), " "] }), (0, import_jsx_runtime2.jsx)(UserDisplayName, { currentUserId: currentUser.id, isFirst: index === 0, separator: separator2, userId: id }), " "] }, id);
    });
  }, [currentUser, userIds, t]);
  return (0, import_jsx_runtime2.jsxs)(ContentStack$1, { padding: 1, children: [(0, import_jsx_runtime2.jsx)(Flex, { justify: "center", paddingBottom: 2, paddingTop: 1, children: (0, import_jsx_runtime2.jsx)(EmojiText, { size: 4, children: COMMENT_REACTION_EMOJIS[reactionName] }) }), (0, import_jsx_runtime2.jsx)(TextBox, { children: (0, import_jsx_runtime2.jsx)(Translate, { t, i18nKey: "comments.user-reacted-with", values: { reactionName }, components: { Content: () => (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: content }), Text: (_ref53) => {
    let { children } = _ref53;
    ...
    let { children } = _ref54;
    return (0, import_jsx_runtime2.jsx)(InlineText, { muted: true, children });
  } } }) })] });
}
...
var _a$o;
var TransparentCard = ut(Card)(_a$o || (_a$o = __template$o(["\n  background: none;\n"])));
...
var CommentReactionsBar = import_react3.default.memo(function CommentReactionsBar2(props) {
  ...
  return (0, import_jsx_runtime2.jsx)(Flex, { align: "center", gap: 1, wrap: "wrap", children: (0, import_jsx_runtime2.jsxs)(TooltipDelayGroupProvider, { children: [sortedReactions.map((_ref62) => {
    ...
    return (0, import_jsx_runtime2.jsx)(CommentReactionsUsersTooltip, { currentUser, reactionName: name, userIds, children: (0, import_jsx_runtime2.jsx)(TransparentCard, { tone: "default", children: (0, import_jsx_runtime2.jsx)(Button, { disabled: readOnly, mode: "ghost", onClick: () => handleSelect(name), padding: 2, radius: "full", selected: hasReacted, tone: hasReacted ? "primary" : "default", children: (0, import_jsx_runtime2.jsxs)(Flex, { align: "center", gap: 1, children: [(0, import_jsx_runtime2.jsx)(EmojiText, { size: 1, children: emoji }), (0, import_jsx_runtime2.jsx)(Text, { size: 0, weight: hasReacted ? "semibold" : "medium", children: reactionsList == null ? void 0 : reactionsList.length })] }) }) }) }, name);
  }), (0, import_jsx_runtime2.jsx)(TransparentCard, { tone: "default", children: (0, import_jsx_runtime2.jsx)(CommentReactionsMenuButton, { onSelect: (o) => handleSelect(o.shortName), options: COMMENT_REACTION_OPTIONS, readOnly, renderMenuButton: renderMenuButton$1 }) })] }) });
});
...
var renderMenuButton = (_ref63) => {
  let { open, t } = _ref63;
  return (0, import_jsx_runtime2.jsx)(Button2, { "aria-label": t("comments.list-item-context-menu-add-reaction-aria-label"), icon: ReactionIcon, mode: "bleed", selected: open, tooltipProps: { content: t("comments.list-item-context-menu-add-reaction") } });
};
var POPOVER_PROPS = { placement: "bottom-end" };
var FloatingCard = ut(Card)(_a$n || (_a$n = __template$n(["\n  &:empty {\n    display: none;\n  }\n"])));
function CommentsListItemContextMenu(props) {
  const { canDelete, canEdit, isParent, onCopyLink, onDeleteStart, onEditStart, onMenuClose, onMenuOpen, onReactionSelect, onStatusChange, readOnly, status } = props;
  const showMenuButton = Boolean(onCopyLink || onDeleteStart || onEditStart);
  const { t } = useTranslation2(commentsLocaleNamespace);
  return (0, import_jsx_runtime2.jsx)(TooltipDelayGroupProvider, { children: (0, import_jsx_runtime2.jsx)(Flex, { children: (0, import_jsx_runtime2.jsxs)(FloatingCard, { display: "flex", shadow: 2, padding: 1, radius: 2, sizing: "border", children: [onReactionSelect && (0, import_jsx_runtime2.jsx)(CommentReactionsMenuButton, { onMenuClose, onMenuOpen, onSelect: onReactionSelect, options: COMMENT_REACTION_OPTIONS, readOnly, renderMenuButton }), isParent && (0, import_jsx_runtime2.jsx)(Button2, { "aria-label": status === "open" ? t("comments.list-item-resolved-tooltip-aria-label") : t("comments.list-item-re-open-resolved-aria-label"), disabled: readOnly, icon: status === "open" ? CheckmarkCircleIcon : UndoIcon, mode: "bleed", onClick: onStatusChange, tooltipProps: { content: status === "open" ? t("comments.list-item-resolved-tooltip-content") : t("comments.list-item-re-open-resolved") } }), (0, import_jsx_runtime2.jsx)(MenuButton, { id: "comment-actions-menu", button: (0, import_jsx_runtime2.jsx)(ContextMenuButton, { "aria-label": t("comments.list-item-open-menu-aria-label"), disabled: readOnly, hidden: !showMenuButton }), onOpen: onMenuOpen, onClose: onMenuClose, menu: (0, import_jsx_runtime2.jsxs)(Menu, { children: [(0, import_jsx_runtime2.jsx)(MenuItem, { hidden: !canEdit, icon: EditIcon, onClick: onEditStart, text: t("comments.list-item-edit-comment") }), (0, import_jsx_runtime2.jsx)(MenuItem, { hidden: !canDelete, icon: TrashIcon, onClick: onDeleteStart, text: t("comments.list-item-delete-comment"), tone: "critical" }), (0, import_jsx_runtime2.jsx)(MenuDivider, { hidden: !canDelete && !canEdit }), (0, import_jsx_runtime2.jsx)(MenuItem, { hidden: !onCopyLink, icon: LinkIcon, onClick: onCopyLink, text: t("comments.list-item-copy-link") })] }), popover: POPOVER_PROPS })] }) }) });
}
...
var ContextMenuBox = ut(Box)(_a$m || (_a$m = __template$m([""])));
...
var TimeText = ut(Text)((_ref64) => {
  ...
  return at(_b$b || (_b$b = __template$m(["\n    min-width: max-content;\n    --card-fg-color: ", ";\n    color: var(--card-fg-color);\n  "])), fg);
});
var InnerStack = ut(Stack)(_c$5 || (_c$5 = __template$m(["\n  transition: opacity 200ms ease;\n\n  &[data-muted='true'] {\n    transition: unset;\n    opacity: 0.5;\n  }\n"])));
var ErrorFlex = ut(Flex)(_d$2 || (_d$2 = __template$m(["\n  min-height: ", "px;\n"])), AVATAR_HEIGHT);
var RetryCardButton = ut(Card)(_e$1 || (_e$1 = __template$m(["\n  // Add not on hover\n  &:not(:hover) {\n    background-color: transparent;\n  }\n"])));
var RootStack = ut(Stack)((_ref65) => {
  let { theme } = _ref65;
  const { space } = theme.sanity;
  return at(_f$1 || (_f$1 = __template$m(["\n    position: relative;\n\n    // Only show the floating layer on hover when hover is supported.\n    // Else, the layer is always visible.\n    @media (hover: hover) {\n      ", " {\n        opacity: 0;\n        position: absolute;\n        right: 0;\n        top: 0;\n        transform: translate(", "px, -", "px);\n      }\n\n      ", " {\n        &:focus-within {\n          opacity: 1;\n        }\n      }\n\n      &:hover {\n        ", " {\n          opacity: 1;\n        }\n      }\n    }\n\n    &[data-menu-open='true'] {\n      ", " {\n        opacity: 1;\n      }\n    }\n  "])), ContextMenuBox, space[1], space[1], ContextMenuBox, ContextMenuBox, ContextMenuBox);
});
var TIME_AGO_OPTS = { agoSuffix: true };
function CommentsListItemLayout(props) {
  const { canDelete, canEdit, comment, currentUser, hasError, isParent, isRetrying, mentionOptions, onCopyLink, onCreateRetry, onDelete, onEdit, onInputKeyDown, onReactionSelect, onStatusChange, readOnly } = props;
...
function CreateNewThreadInput(props) {
  ...
  const placeholder = (0, import_jsx_runtime2.jsx)(Translate, { t, i18nKey: "comments.placeholder-create-thread", components: { Strong: () => (0, import_jsx_runtime2.jsx)("b", { children: fieldName }) } });
...
function CommentsListStatus(props) {
  ...
  if (error) {
    return (0, import_jsx_runtime2.jsx)(Flex, { align: "center", justify: "center", flex: 1, padding: 4, children: (0, import_jsx_runtime2.jsx)(Flex, { align: "center", children: (0, import_jsx_runtime2.jsx)(Text, { size: 1, muted: true, children: t("comments.list-status-error") }) }) });
  }
  if (loading) {
    return (0, import_jsx_runtime2.jsx)(LoadingBlock, { showText: true, title: t("comments.list-status-loading") });
  }
  if (hasNoComments) {
...
var CommentsListInner = (0, import_react3.forwardRef)(function CommentsListInner2(props, ref) {
  const { comments: comments2, currentUser, error, loading, mentionOptions, onCopyLink, onCreateRetry, onDelete, onEdit, onNewThreadCreate, onPathSelect, onReactionSelect, onReply, onStatusChange, readOnly, selectedPath, status } = props;
  ...
  return (0, import_jsx_runtime2.jsxs)(Flex, { direction: "column", flex: 1, height: "fill", overflow: "hidden", ref: setBoundaryElement, sizing: "border", children: [(0, import_jsx_runtime2.jsx)(CommentsListStatus, { error, hasNoComments: groupedThreads.length === 0, loading, status }), showComments && (0, import_jsx_runtime2.jsx)(Stack, { as: "ul", flex: 1, overflow: "auto", padding: 3, paddingTop: 1, paddingBottom: 6, sizing: "border", space: 1, children: (0, import_jsx_runtime2.jsx)(BoundaryElementProvider, { element: boundaryElement, children: groupedThreads == null ? void 0 : groupedThreads.map((_ref70) => {
    ...
    return (0, import_jsx_runtime2.jsx)(Stack, { as: "li", "data-group-id": firstThreadId, paddingTop: 3, children: (0, import_jsx_runtime2.jsx)(CommentThreadLayout, { breadcrumbs, canCreateNewThread: status === "open", currentUser, fieldPath, isSelected: newThreadSelected, mentionOptions, onNewThreadCreate, onPathSelect, readOnly, children: group.map((item) => {
      ...
      return (0, import_jsx_runtime2.jsx)(CommentsListItem, { canReply, currentUser, isSelected: threadIsSelected, mentionOptions, onCopyLink, onCreateRetry, onDelete, onEdit, onPathSelect, onReactionSelect, onReply, onStatusChange, parentComment: item.parentComment, readOnly, replies }, item.parentComment._id);
    }) }, fieldPath) }, fieldPath);
  }) }) })] });
});
var CommentsList = import_react3.default.memo(CommentsListInner);
function getDialogCopy(t) {
  return { thread: { title: t("comments.delete-thread-title"), body: t("comments.delete-thread-body"), confirmButtonText: t("comments.delete-thread-confirm") }, comment: { title: t("comments.delete-comment-title"), body: t("comments.delete-comment-body"), confirmButtonText: t("comments.delete-comment-confirm") } };
}
...
function CommentsOnboardingPopover(props) {
  ...
  const { t } = useTranslation2(commentsLocaleNamespace);
  return (0, import_jsx_runtime2.jsx)(StyledPopover, { content: (0, import_jsx_runtime2.jsx)(Root$7, { padding: 4, children: (0, import_jsx_runtime2.jsxs)(Stack, { space: 3, children: [(0, import_jsx_runtime2.jsx)(Text, { weight: "medium", size: 1, children: t("comments.onboarding-popover-header") }), (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: t("comments.onboarding-popover-body") }), (0, import_jsx_runtime2.jsx)(Flex, { justify: "flex-end", marginTop: 2, children: (0, import_jsx_runtime2.jsx)(Button2, { text: t("comments.onboarding-popover-dismiss"), tone: "primary", onClick: onDismiss }) })] }) }), open: true, portal: true, ...props });
}
...
function useNotificationTarget(opts) {
  ...
  const handleGetNotificationValue = (0, import_react3.useCallback)((_ref73) => {
...
var CommentsProvider = (0, import_react3.memo)(function CommentsProvider2(props) {
  ...
  const ctxValue = (0, import_react3.useMemo)(() => ({ isRunningSetup, status, setStatus, getComment, isCommentsOpen, onCommentsOpen, comments: { data: threadItemsByStatus, error, loading: loading || isRunningSetup }, operation: { create: operation.create, edit: operation.edit, react: operation.react, remove: operation.remove, update: operation.update }, mentionOptions }), [error, getComment, isCommentsOpen, isRunningSetup, loading, mentionOptions, onCommentsOpen, operation.create, operation.edit, operation.react, operation.remove, operation.update, status, threadItemsByStatus]);
...
function CommentsInspectorFeedbackFooter() {
  const { t } = useTranslation2(commentsLocaleNamespace);
  return (0, import_jsx_runtime2.jsx)(FooterCard, { padding: 4, children: (0, import_jsx_runtime2.jsxs)(Text, { muted: true, size: 1, children: [t("comments.feedback-footer-title"), " ", (0, import_jsx_runtime2.jsxs)(Link, { href: FEEDBACK_FORM_LINK, target: "_blank", rel: "noreferrer", children: [(0, import_jsx_runtime2.jsxs)(Span, { children: [t("comments.feedback-footer-link"), " "] }), " ", (0, import_jsx_runtime2.jsx)(LaunchIcon, {})] })] }) });
}
...
function CommentsInspectorInner(props) {
  ...
  const handleCopyLink = (0, import_react3.useCallback)((id) => {
    ...
    navigator.clipboard.writeText(url).then(() => {
      pushToast({ closable: true, status: "info", title: t("comments.copy-link-success-message") });
    }).catch(() => {
      pushToast({ closable: true, status: "error", title: t("comments.copy-link-error-message") });
    });
...
function CommentsFieldButton(props) {
  ...
  useClickOutside(handleClickOutside, [popoverElement]);
  if (!hasComments) {
    const placeholder = (0, import_jsx_runtime2.jsx)(Translate, { t, i18nKey: "comments.placeholder-add-comment-field-title", components: { Strong: () => (0, import_jsx_runtime2.jsx)("b", { children: fieldTitle }) } });
    ...
    return (0, import_jsx_runtime2.jsx)(Popover2, { constrainSize: true, content, fallbackPlacements: ["bottom-end"], open, placement: "right-start", portal: true, ref: setPopoverElement, onKeyDown: handlePopoverKeyDown, children: (0, import_jsx_runtime2.jsx)("div", { children: (0, import_jsx_runtime2.jsx)(Button2, { "aria-label": t("comments.field-button-aria-label-add"), disabled: isRunningSetup, icon: AddCommentIcon, mode: "bleed", onClick, ref: setAddCommentButtonElement, selected: open, tooltipProps: { content: t("comments.field-button-title"), placement: "top" } }) }) });
  }
  return (0, import_jsx_runtime2.jsx)(Tooltip, { portal: true, placement: "top", content: t("comments.field-button-content", { count }), children: (0, import_jsx_runtime2.jsx)(Button, { "aria-label": t("comments.field-button-aria-label-open"), mode: "bleed", onClick, padding: 2, space: 2, children: (0, import_jsx_runtime2.jsxs)(Flex, { align: "center", gap: 2, children: [(0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (0, import_jsx_runtime2.jsx)(CommentIcon2, {}) }), (0, import_jsx_runtime2.jsx)(Text, { size: 0, children: count > 9 ? "9+" : count })] }) }) });
}
var __freeze$e = Object.freeze;
var __defProp$e = Object.defineProperty;
var __template$e = (cooked, raw) => __freeze$e(__defProp$e(cooked, "raw", { value: __freeze$e(raw || cooked.slice()) }));
...
var Timeline = (_ref81) => {
  ...
  const renderItem2 = (0, import_react3.useCallback)((chunk, _ref82) => {
...
var structureTool = definePlugin((options) => {
  ...
  return { name: "sanity/structure", document: { actions: (prevActions) => {
    ...
    icon,
    component: (0, import_react3.lazy)(() => import("./index-MAAxgUnl-R2VAMZGG.js")),
...
function DocumentListPaneContent(props) {
  ...
  const renderItem2 = (0, import_react3.useCallback)((item, _ref115) => {
...
var DocumentListPaneHeader = (0, import_react3.memo)((_ref117) => {
...
//# sourceMappingURL=chunk-V4J2STWG.js.map
