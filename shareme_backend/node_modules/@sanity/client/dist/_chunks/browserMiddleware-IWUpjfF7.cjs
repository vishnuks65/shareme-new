...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    operators.combineLatestWith(
      rxjs.from(
        Promise.resolve().then(function () { return require('./stegaEncodeSourceMap-YNx-0kzT.cjs'); }).then(function (n) { return n.stegaEncodeSourceMap$1; }).then(
...
//# sourceMappingURL=browserMiddleware-IWUpjfF7.cjs.map
